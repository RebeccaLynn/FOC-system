...
public class FacultyMainPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel19.setText("To remove members going off of a committee this year, click Update.");
        ...
        jLabel1.setText("Select a current faculty member to edit or remove or add a new faculty.  ");
        ...
        jLabel24.setText("Select a current committee to edit, remove, or view positions or create a new committee. ");
 ...
 */
    ...
    /**
     * Action listener for update all button
     * @param evt 
     */
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        try{
            ...
            results = c.searchFaculty(toSearch);
            for (int i = 0; i < results.size(); i++){
               listModel10.addElement(results.get(i));
           }
            jList1.setModel(listModel10);
 ...
 */
    ...
    /**
     * Action listener for view committees button
     * @param evt 
     */
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
       try{
           String committee = jList4.getSelectedValue().toString();
           Connect c = new Connect ();
           DefaultListModel listModel9 = new DefaultListModel();  
           ArrayList<String> search;
           search = c.searchCommittees(committee);
           for (int i = 0; i < search.size(); i++){
             listModel9.addElement(search.get(i));
           }
               jList2.setModel(listModel9);
        }
