...
INSERT INTO committees VALUES (1, 'Undergraduate Education');
INSERT INTO committees VALUES (2, 'Treasure');
INSERT INTO committees VALUES (3, 'Academics Services');
INSERT INTO committees VALUES (4, 'Test Scores');
...
(
    ...
    FOREIGN KEY (memberFK_id) REFERENCES committees(id)
);
...
(
    ...
    FOREIGN KEY (positionFK_id) REFERENCES committees(id)
);
